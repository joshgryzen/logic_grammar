...
prefix: quantification | unary_connective
...
quantification: quantifier VAR+

quantifier: "forall"  | "exists"

primary: "(" formula ")" | atomic_formula

atomic_formula: "true" | "false" | comparison | atom

comparison: term relation term | term relation comparison

relation: ">=" | "<=" | ">" | "<" | "!=" | "="

term: ASCII_ALPHA_LOWER | ASCII_DIGIT | "inf" | "sup"

atom: PRED
    | PRED "(" VAR ")"

PRED: ASCII_ALPHA_LOWER
...
annotated_formula: "spec:" formula

specification: (annotated_formula ".")*

# Specification only for now
start: specification
"""
